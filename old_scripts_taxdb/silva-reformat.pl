...
my ($outDir, $force, $version, $mapseqLoc, $help);
my $URL = 'https://www.arb-silva.de/fileadmin/silva_databases/release_138.1/Exports/';
...
#TODO: Fix this bit of the code, as we only need the LSU and SSU fasta

# my @files = qw(SILVA_132_SSURef_tax_silva_trunc.fasta.gz SILVA_132_LSURef_tax_silva_trunc.fasta.gz taxmap_slv_ssu_ref_132-corrected.txt.gz taxmap_slv_lsu_ref_132.txt.gz);
# my @files = qw(SILVA_128_SSURef_tax_silva_trunc.fasta.gz SILVA_128_LSURef_tax_silva_trunc.fasta.gz taxmap_slv_ssu_ref_128.txt.gz taxmap_slv_lsu_ref_128.txt.gz);
my @files = qw(SILVA_138.1_SSURef_tax_silva_trunc.fasta.gz SILVA_138.1_LSURef_tax_silva_trunc.fasta.gz taxmap_slv_ssu_ref_138.1.txt.gz taxmap_slv_lsu_ref_138.1.txt.gz);
