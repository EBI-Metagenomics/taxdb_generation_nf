...
process GENERATE_UNITE_TAX {
    ...
    sed 's/g__.*_Incertae_sedis/g__/g' temp_unite.tax | sed 's/f__.*_Incertae_sedis/f__/g' | sed 's/c__.*_Incertae_sedis/c__/g' | sed 's/p__.*_Incertae_sedis/p__/g' | sed 's/k__.*_Incertae_sedis/k__/g' | grep -v "p__;" > processed_tax.txt
